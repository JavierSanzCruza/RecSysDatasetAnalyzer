...
class IndividualProperty(ABC):
    ...
    @abstractmethod
    def average_filter(self, rating_matrix, user_filter=lambda x: x, item_filter=lambda x: x, rating_filter=lambda x: x):
        """
        Finds the average value of the property over all the relevant ratings.
        :param rating_matrix: the rating matrix.
    ...
    def average_users(self, rating_matrix):
        """
        Finds the average value of a property for the different users.
        :param rating_matrix: the rating matrix.
    ...
    def average_relevant_users(self, rating_matrix):
        """
        Finds the average value of a property for the different users (limited to the set of users).
        :param rating_matrix: the rating matrix.
        :return: the average value for each user.
        """
        pass
    ...
    @abstractmethod
    def average_filter_users(self, rating_matrix, user_filter=lambda x: x, item_filter=lambda x: x, rating_filter=lambda x: x):
        """
        Finds the average value of a property for the different users (limited to a set of ratings).
        :param rating_matrix: the rating matrix.
        :param user_filter: (OPTIONAL) filter for the users. By default, no filter is applied.
        :param item_filter: (OPTIONAL) filter for the items. By default, no filter is applied.
        :param rating_filter: (OPTIONAL) filter for the ratings. By default, no filter is applied.
    ...
    @abstractmethod
    def max_filter_users(self, rating_matrix, user_filter=lambda x: x, item_filter=lambda x: x, rating_filter=lambda x: x):
        pass
